...
<body class="bg-white">
    <div class="w-screen h-screen">
        ...
        <div class="mx-8 mt-8">
            ...
            <button onclick="redirectToAddMenu()" class="btn btn-outline btn-block text-base rounded-3xl bg-gray-100 hover:bg-gray-300 text-black">Add New Menu</button>
        </div>
                ...
                <tbody>
                    <?php foreach ($menu as $index => $menuitem) : ?>
                        <tr class="text-black font-text font-medium">
                            ...
                            <td>
                                <button class="my-2" onclick="showConfirmationModal(<?= esc($menuitem->id); ?>)">
